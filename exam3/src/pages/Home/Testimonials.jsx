...
export default function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      className="fade-in-on-scroll w-full bg-[#272727] text-white py-20 px-4 md:px-12 testimonial-slider"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          {reviews.map((item, index) => (
            ...
            >
              <div className="testimonial-card border border-[#FCD34D]/30 bg-[#2d2d2d]/40 p-8 pt-14 relative rounded-none flex flex-col justify-between h-[250px]">
                <div className="testimonial-avatar absolute -top-10 left-6 w-20 h-20 rounded-full border-2 border-[#272727] overflow-hidden bg-zinc-800 shadow-xl">
                  <img
                    src={item.avatar}
                    alt={item.name}
                ...
                <div className="absolute top-6 right-8 text-[#FCD34D] opacity-80 icon-animate">
                  <svg
